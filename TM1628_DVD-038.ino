...
unsigned int segHexNumber[16][2] ={
  //        --cbafed     ------g-
         ...
         (0b00110000),(0b00000000), // 1
         (0b00011011),(0b00000010), // 2 
         (0b00111001),(0b00000010), // 3
         (0b00110100),(0b00000010), // 4
         (0b00101101),(0b00000010), // 5
         (0b00101111),(0b00000010), // 6
         (0b00111000),(0b00000000), // 7
         (0b01111111),(0b00000010), // 8 
         (0b00111100),(0b00000010), // 9 
         (0b00111110),(0b00000010), // A 
         (0b00100111),(0b00000010), // B
         (0b00001111),(0b00000000), // C
         (0b00110011),(0b00000010), // D
         (0b00001111),(0b00000010), // E
         (0b00001110),(0b00000010)  // F
};
...
void test_hexadecimal_DSP(){
  for(uint8_t num = 0; num < 16; num++){
    delayMicroseconds(1);
              ...
              delayMicroseconds(1);
              //
              cmd_without_stb(segHexNumber[num][0]);  //This will represent the "number" created at position from 0~16 Byte HL & HU
              cmd_without_stb(segHexNumber[num][1]);  //This will represent the "number" created at position from 0~16 Byte HL & HU
              //
              digitalWrite(DSP_stb, HIGH);
...
void test_symbols_DSP(void){
  digitalWrite(DSP_stb, LOW);
      ...
      //               
      cmd_without_stb(0b00000000); //DIG1 --cbafed
      cmd_without_stb(0b00000000); //DIG1 ------g-
      //                              
      cmd_without_stb(0b00000000); //DIG2 --cbafed
      cmd_without_stb(0b00000000); //DIG2 ------g-
      //
      cmd_without_stb(0b00000000); //DIG3 --cbafed 
      cmd_without_stb(0b00000000); //DIG3 ------g-
      //
      cmd_without_stb(0b00000000); //DIG4 --cbafed
      cmd_without_stb(0b00000000); //DIG4 ------g-
      //
      cmd_without_stb(0b00000000); //DIG5 --cbafed
      cmd_without_stb(0b00000000); //DIG5 ------g-
      //
      cmd_without_stb(0b00000000); //DIG6 -, -,  CD,  ":", DVD, VCD, play, pause
      cmd_without_stb(0b00000000); //DIG6 ------mp3-
      //
      cmd_without_stb(0b00000000); //DIG7 --cbafed
      cmd_without_stb(0b00000000); //DIG7 ------g-
      //
      digitalWrite(DSP_stb, HIGH);
      cmd_with_stb((0b10001000) | 7); //cmd 4
      delay(200);
...
void updateDisplay(void){
    ...
    digitalWrite(DSP_stb, LOW);
    delayMicroseconds(1);
    // Is importante fill the next two lines, to write the seconds at firt digit
    // also is possible write direct to the position of the register of digit
    // but in this case is neccessary use dynamic mode!
    ...
    cmd_without_stb(0b00000000);  //They have skiped this digit on this panel
    cmd_without_stb(0b00000000);  //They have skiped this digit on this panel
    // Minutes units
    ...
    //
    cmd_without_stb(0b00010000);  //DIG6 -, -,  CD,  ":", DVD, VCD, play, pause
    cmd_without_stb(0b00000000);  //------mp3-
