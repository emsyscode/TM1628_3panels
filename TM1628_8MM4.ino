...
unsigned int segHexNumber[16][2] ={
  //        eabcd---     ------gf
         (0b11111000),(0b00000001), // 0
         (0b00110000),(0b00000000), // 1
         (0b11101000),(0b00000010), // 2 
         (0b01111000),(0b00000010), // 3
         (0b00110000),(0b00000011), // 4
         (0b01011000),(0b00000011), // 5
         (0b11011000),(0b00000011), // 6
         (0b01110000),(0b00000000), // 7
         (0b11111000),(0b00000011), // 8 
         (0b01110000),(0b00000011), // 9 
         (0b11110000),(0b00000011), // A 
         (0b10011000),(0b00000011), // B
         (0b11001000),(0b00000001), // C
         (0b10111000),(0b00000010), // D
         (0b11001000),(0b00000011), // E
         (0b11000000),(0b00000011)  // F
};
...
void test_hexadecimal_DSP(){
  for(uint8_t num = 0; num < 16; num++){
    delayMicroseconds(1);
              ...
              delayMicroseconds(1);
              //
              cmd_without_stb(0b00000000);  //This belongs to the digit position used to draw symbols
              cmd_without_stb(0b00000000);  //This belongs to the digit position used to draw symbols
              //
...
void test_symbols_DSP(void){
  digitalWrite(DSP_stb, LOW);
      ...
      //               (--------) // Grid of symbols
      //               (--------) // Grid of Symbols
      cmd_without_stb(0b11111000); //symbols
      cmd_without_stb(0b00000011); //more 2 symbols at bit 0 and 1
      //                              
      cmd_without_stb(0b00000000); //DIG1 eabcd---
      cmd_without_stb(0b00000000); //DIG1 ------gf
      //
      cmd_without_stb(0b00000000); //DIG2 eabcd--- 
      cmd_without_stb(0b00000000); //DIG2 ------gf
      //
      cmd_without_stb(0b00000000); //DIG3 eabcd---
      cmd_without_stb(0b00000000); //DIG3 ------gf
      //
      cmd_without_stb(0b00000000); //DIG4 eabcd---
      cmd_without_stb(0b00000000); //DIG4 ------gf
      //
      cmd_without_stb(0b00000000); //DIG5 eabcd---
      cmd_without_stb(0b00000000); //DIG5 ------gf
      //
      cmd_without_stb(0b00000000); //DIG6 eabcd---
      cmd_without_stb(0b00000000); //DIG6 ------gf
      //
      digitalWrite(DSP_stb, HIGH);
      cmd_with_stb((0b10001000) | 7); //cmd 4
      delay(200);
